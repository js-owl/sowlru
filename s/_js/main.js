...
// //======================================================= FATIGUE ANALYSIS ====================================================================
// var fbrft_string=document.getElementById("fbrft").value;
// var fbrft=parseFloat(fbrft_string);

// var fmin_string=document.getElementById("fmin").value;
// var fmax_string=document.getElementById("fmax").value;
// var Rround=fmin_string/fmax_string;
// var R=Rround.toFixed(2);
// var R_out = document.getElementById("R"); R_out.innerHTML = R;

// //===================================================== DFR base unstabilyzed =====================================================
// var DFRbase_sin=DFRbase_s(fType, cMat, fbrft, t, maxD);
// var getDFRbase_s = document.getElementById("DFRbase_single"); getDFRbase_s.innerHTML = DFRbase_sin;
// //===================================================== DFR base stabilyzed =====================================================
// var DFRbase_doub=DFRbase_d(fType, cMat, fbrft, t, maxD, R);
// var getDFRbase_d = document.getElementById("DFRbase_doub"); getDFRbase_d.innerHTML = DFRbase_doub;
// //============================================ DFRbase - summary =================================================================
// var DFRb = function (val) {this.val = val;}; var DFRb_Arr = [];
// DFRb_Arr[0] = new DFRb(DFRbase_sin); 
// DFRb_Arr[1] = new DFRb(DFRbase_doub); 


// var	DFRbase = document.getElementsByName("DFRbase_index");
// var	lDFRbase = DFRbase.length;
// for (var n=0; n<lDFRbase; n++){
// 	if (DFRbase[n].checked){
// 		choosen_DFRb=DFRb_Arr[n].val;
// 	}
// }
// var DFRbsum = document.getElementById("DFRb_summary_out"); DFRbsum.innerHTML = choosen_DFRb;

// //===================================================== factor A - general text ===============================================================
// var factor_A_general = document.getElementById("factorA_general");
// factor_A_general.innerHTML = "(" + fType + ", f.material: " + fMat + ", "+hType+" head, manufactured head side) = ";

// //================================= factor A - manufactured head side - Driven per BAC5004-1 =================================================
// var factorA=function_A(fType,hType);
// var A0 = document.getElementById("A_out"); 	A0.innerHTML = factorA;
// var A1 = document.getElementById("A_cw_out"); 	A1.innerHTML = factorA;

// //================================= factor A - manufactured head side - OverDriven per BAC5004-1 =============================================
// var factorA_overdriven=functionA_overdriven(fType,hType);
// var A2 = document.getElementById("A_overdriven_out");		A2.innerHTML = factorA_overdriven;
// var A3 = document.getElementById("A_overdriven_cw_out");	A3.innerHTML = factorA_overdriven;

// //================================= factor A - manufactured head side - Class I ====================================================
// var factorA_class1=functionA_class1(fType,hType);
// var A4 = document.getElementById("A_class1_out"); 	A4.innerHTML = factorA_class1;
// var A5 = document.getElementById("A_class1_cw_out"); 	A5.innerHTML = factorA_class1;

// //============================================ factor A - summary =================================================================
// var FactA = function (val) {this.val = val;}; var factors_A = [];
// factors_A[0] = new FactA(factorA); 
// factors_A[2] = new FactA(factorA_overdriven); 
// factors_A[4] = new FactA(factorA_class1);

// var	factorsA = document.getElementsByName("A_index");
// var	lfactorsA = factorsA.length;
// for (var m=0; m<lfactorsA; m++){
// 	if (factorsA[m].checked){
// 		choosen_A=factors_A[m].val;
// 	}
// }
// var Asum = document.getElementById("A_summary_out"); Asum.innerHTML = choosen_A;
// //========================================================== Fatigue summary =================================================================
// var DFRstring = choosen_DFRb*choosen_A;
// var DFR = DFRstring.toFixed(2);
// var DFROut = document.getElementById("DFR_index"); DFROut.innerHTML = "DFR = DFRbase*Afactor = "+choosen_DFRb+"*"+choosen_A+"="+DFR+" ksi.";

// var N95 = N95_function(cMat,R,DFR,fmax_string);
// var N95_Out = document.getElementById("N95_index"); N95_Out.innerHTML = "N95 = SN curve (DFR="+DFR+" ksi, fmax="+fmax_string+" ksi and R="+R+") ="+N95+" cycles.";

// var GAG_DR=document.getElementById("GAG_DR").value;
// var FRF=document.getElementById("FRF").value;
// var threshold_string = N95*GAG_DR/FRF;
// var threshold = threshold_string.toFixed(0);
// var threshold_Out = document.getElementById("threshold_index"); threshold_Out.innerHTML = "Threshold = N95*GAG_DR/FRF= "+N95+"*"+GAG_DR+"/"+FRF+"="+threshold+" cycles.";
...
// //======================================================= CONVERSIONS //====================================================================
// //================================= Convert mm to inch ===========================================================
// var m2i_in=document.getElementById("m2i_in").value;
// var m2i_out = document.getElementById("m2i_out");
// m2i_out.innerHTML = " ="+m2i(m2i_in)+" inch.	";
// //================================= Convert MPa to ksi ===========================================================
// var M2k_in=document.getElementById("M2k_in").value;
// var M2k_out = document.getElementById("M2k_out");
// M2k_out.innerHTML = " ="+M2k(M2k_in)+" ksi.";
// //================================= Convert kg/m3 to lbs/in3 =====================================================
// var d2d_in=document.getElementById("d2d_in").value;
// var d2d_out = document.getElementById("d2d_out");
// d2d_out.innerHTML = " ="+d2d(d2d_in)+" lbs/in3.";
// }